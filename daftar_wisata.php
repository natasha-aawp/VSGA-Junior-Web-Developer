    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-14">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tabel Data Wisata</h5>
              <?php
              include 'koneksi.php';
              ?>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $d['harga_wisata']; ?></td>
                      <td>
                        <a class="btn btn-primary" href="index.php?id_wisata=<?= $d['id_wisata'] ?>">EDIT</a>
                        <a class="btn btn-danger" href="eksekusi/eksekusi_hapus_wisata.php?id_wisata=<?= $d['id_wisata'] ?>">Hapus</a>
                      </td>
                    <?php
                  }
                    ?>
